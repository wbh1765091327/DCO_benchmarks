...
if __name__ == "__main__":
    for K in [10]:
        ...
        plt.savefig(f'E:/cppwork/dco_benchmarks/DATA/figure/PDX-ALL/IVF/nary_ivf_qps_subplots_@{K}_simd_dist_time.png', dpi=400, bbox_inches='tight')
        plt.show()
