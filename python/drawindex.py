...
# # 保存完整的两子图组合
# plt.savefig(f'E:/cppwork/dco_benchmarks/DATA/figure/ALL/HNSW/hnsw_index_volume.png', dpi=400, bbox_inches='tight')    
...
plt.savefig(f'E:/cppwork/dco_benchmarks/DATA/figure/ALL/HNSW/hnsw_preprocessing_time.png', dpi=400, bbox_inches='tight',format='PNG')
plt.close(fig_left)
...
plt.tight_layout(rect=[0, 0.2, 1, 0.85])
plt.savefig(f'E:/cppwork/dco_benchmarks/DATA/figure/ALL/HNSW/ivf_preprocessing_time.PNG', dpi=400, bbox_inches='tight',format='png')
plt.close(fig_right)
