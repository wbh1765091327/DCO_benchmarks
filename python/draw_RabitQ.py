...
if __name__ == "__main__":
    ...
    for K in [10]:
        ...
        plt.savefig(f'E:/cppwork/dco_benchmarks/DATA/figure/RabitQ/RabitQ_hnsw.png', dpi=400, bbox_inches='tight')
        plt.show()
    ...
    for K in [10]:
        ...
        plt.rc('font', family='Times New Roman')
        plt.savefig(f'E:/cppwork/dco_benchmarks/DATA/figure/RabitQ/RabitQ_ivf.png', dpi=400, bbox_inches='tight')
        plt.show()
