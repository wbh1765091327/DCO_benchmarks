...
if __name__ == "__main__":
    for K in [10]:
        ...
        for idx, dataset in enumerate(datasets):
            ...
            for i in range(6):
                if i == 0:
                    ...
                    label = "hnsw-finger_simd"
                    filename = f"E:\cppwork/dco_benchmarks\DATA\Resnew\hnsw\simd\HNSW_RES_simd_9_dist_time.csv"
                elif i == 5:
                    label = "hnsw-dade_simd"
        ...
        plt.savefig(f'E:/cppwork/dco_benchmarks/DATA/figure/DADE//ivf_qps_subplots_@{K}_simd_dist_time.png', dpi=400, bbox_inches='tight')
        plt.show()
    ...
    for K in [10]:
        ...
        for idx, dataset in enumerate(datasets):
            ...
            for i in range(6):
                if i == 0:
                    ...
                    label = "hnsw-adsampling-nosimd"
                    filename = f"E:/cppwork/dco_benchmarks/DATA/Resnew/hnsw/nosimd/HNSW_RES_nosimd_1_dist_time.csv"
                elif i == 2:
                    label = "hnsw-bsa-learnedl2-nosimd"
                    filename = f"E:/cppwork/dco_benchmarks/DATA/Resnew/hnsw/nosimd/HNSW_RES_nosimd_3_dist_time.csv"
                elif i == 3:
                    label = "hnsw-bsa-uniform-nosimd"
                    filename = f"E:/cppwork/dco_benchmarks/DATA/Resnew/hnsw/nosimd/HNSW_RES_nosimd_5_dist_time.csv"
                elif i == 4:
                    label = "hnsw-finger_nosimd"
                    filename = f"E:\cppwork/dco_benchmarks\DATA\Resnew\hnsw\nosimd\HNSW_RES_nosimd_9_dist_time.csv"
                elif i == 5:
                    label = "hnsw-dade_nosimd"
        ...
        plt.rc('font', family='Times New Roman')
        plt.savefig(f'E:/cppwork/dco_benchmarks/DATA/figure/DADE/IVF/ivf_qps_subplots_@{K}_nosimd_dist_time.png', dpi=400, bbox_inches='tight')
        plt.show()
    for K in [10]:
        n_rows = 2
        n_cols = (len(datasets) + 1) // 2
        ...
        plt.rc('font', family='Times New Roman')
        plt.savefig(f'E:/cppwork/dco_benchmarks/DATA/figure/DADE/IVF/ivf_dco_subplots_@{K}_simd_dist_time.png', dpi=400, bbox_inches='tight')
        plt.show()
    ...
    for K in [10]:
        ...
        plt.rc('font', family='Times New Roman')
        plt.savefig(f'E:/cppwork/dco_benchmarks/DATA/figure/DADE/IVF/ivf_dco_subplots_@{K}_nosimd_dist_time.png', dpi=400, bbox_inches='tight')
        plt.show()
