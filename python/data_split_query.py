...
if __name__ == "__main__":
    for dataset in datasets:
        ...
        save_path = os.path.join(source, f'{dataset}_100k')
        if not os.path.exists(save_path):
            os.makedirs(save_path)

        save_base_path = os.path.join(save_path, f'{dataset}_100k_base.fvecs')
        save_learn_path = os.path.join(save_path, f'{dataset}_100k_learn.fvecs')
        save_query_path = os.path.join(save_path, f'{dataset}_100k_query.fvecs')
        save_ground_path = os.path.join(save_path, f'{dataset}_100k_groundtruth.ivecs')
        save_learn_ground_path = os.path.join(save_path, f'{dataset}_100k_learn_groundtruth.ivecs')
