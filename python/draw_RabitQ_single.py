...
if __name__ == "__main__":
    ...
    for K in [10]:
        ...
        plt.savefig(f'E:/cppwork/dco_benchmarks/DATA/figure/RabitQ/RabitQ_hnsw_single.png', dpi=400, bbox_inches='tight')
        plt.show()
    ...
    for K in [10]:
        ...
        for idx, dataset in enumerate(datasets):
            ...
            for i in range(7):
                if i == 0:
                    ...
                    label = "ivf-RaBitQ_5bit"
                    filename = f"E:/cppwork/dco_benchmarks/DATA/RabitQnew/IVF_5BIT_RabitQ.csv"
                    recall, Qps = load_result_data_RabitQ(filename, dataset)
                elif i == 4:
                    ...
                    label = "ivf-RaBitQ_3bit"
                    filename = f"E:/cppwork/dco_benchmarks/DATA/RabitQ/IVF_RabitQ.csv"
                    recall, Qps = load_result_data_RabitQ(filename, dataset)
        ...
        plt.rc('font', family='Times New Roman')
        plt.savefig(f'E:/cppwork/dco_benchmarks/DATA/figure/RabitQ/RabitQ_ivf_single.png', dpi=400, bbox_inches='tight')
        plt.show()
